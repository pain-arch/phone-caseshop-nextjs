          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite memories with your own, <span className="font-semibold">one-of-one</span> phone case. CaseShop allows you to protect your memories, not just your phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:felx-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  <img className="inline-block h-10 w-10 rounded-full ring ring-slate-100" src="/users/user-1.png" alt="user1" />
                  <img className="inline-block h-10 w-10 rounded-full ring ring-slate-100" src="/users/user-2.png" alt="user2" />
                  <img className="inline-block h-10 w-10 rounded-full ring ring-slate-100" src="/users/user-3.png" alt="user3" />
                  <img className="inline-block h-10 w-10 rounded-full ring ring-slate-100" src="/users/user-4.jpg" alt="user4" />
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring ring-slate-100" src="/users/user-5.jpg" alt="user5" />
                </div>
